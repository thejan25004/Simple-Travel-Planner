        ...
        <View className="px-6 pb-12">
          ...
          <View className="flex-row justify-between">
            ...
            >
              ...
              <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 16 }}>Plan Trip</Text>
              <Text style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: 12, marginTop: 2 }}>New adventure</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 15 }}>Explore</Text>
              <Text style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: 11, marginTop: 1 }}>Discover</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 15 }}>Gallery</Text>
              <Text style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: 11, marginTop: 1 }}>Memories</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
